...
func Test_Parses(t *testing.T) {
	...
	var testCases = []struct {
		...
		{
			ua:             "Mozilla/5.0 (Linux armv7l) AppleWebKit/602.1.28+ (KHTML, like Gecko) Version/9.1 Safari/601.5.17 HZN/4.37 (MN=VIP5002W-PRD;PC=APLSTB;FV=VIP5002W-mon-prd-00.01-129-aq-AL-20211208210000-na001;)",
			deviceID:       2,
			platformID:     2,
			browserID:      3,
			browserVersion: "9.1",
		...
		{
			ua:             "Mozilla/5.0 (compatible; MSIE 10.0; Windows Phone 8.0; Trident/6.0; IEMobile/10.0; ARM; Touch; HTC; Windows Phone 8X by HTC) XXXAndroidApp/0.62",
			deviceID:       4,
			platformID:     9,
			browserID:      2,
			browserVersion: "10.0",
		...
		// bingbot
		{
			ua:             "Mozilla/5.0 (compatible; bingbot/2.0; +http://www.bing.com/bingbot.htm), XFF:207.46.13.108",
			deviceID:       1,
			platformID:     1,
			browserID:      0,
			browserVersion: "",
		...
		{
			ua:             "Mozilla/5.0 (iPhone; CPU iPhone OS 7_0 like Mac OS X) AppleWebKit/537.51.1 (KHTML, like Gecko) Version/7.0 Mobile/11A465 Safari/9537.53 (compatible; bingbot/2.0; +http://www.bing.com/bingbot.htm), XFF:40.77.167.11",
			deviceID:       4,
			platformID:     6,
			browserID:      3,
			browserVersion: "7.0",
		...
		// duck duck
		{
			ua:             "ddg_android/5.90.0 (com.duckduckgo.mobile.android; Android API 29)",
			deviceID:       4,
			platformID:     2,
			browserID:      0,
			browserVersion: "",
		...
		{
			ua:             "AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/81.0.4044.138 DuckDuckGo/5 Safari/537.36",
			deviceID:       1,
			platformID:     1,
			browserID:      0,
			browserVersion: "",
		...
		{
			ua:             "DuckDuckBot/1.0; (+https://duckduckgo.com/duckduckbot.html)",
			deviceID:       1,
			platformID:     1,
			browserID:      0,
			browserVersion: "",
		...
		{
			ua:             "DuckDuckBot/2.0; (+http://duckduckgo.com/duckduckbot.html)",
			deviceID:       1,
			platformID:     1,
			browserID:      0,
			browserVersion: "",
		...
		// facebook bot
		{
			ua:             "facebookexternalhit/1.1;between-scrap/1.0",
			deviceID:       1,
			platformID:     1,
			browserID:      0,
			browserVersion: "",
